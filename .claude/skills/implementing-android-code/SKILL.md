...
version: 0.1.2
description: This skill should be used when implementing Android code in AiSolver2048. Covers critical patterns, gotchas, and anti-patterns unique to this codebase. Triggered by "How do I implement a ViewModel?", "Create a new screen", "Add navigation", "Write a repository", "BaseViewModel pattern", "State-Action-Event", "type-safe navigation", "@Serializable route", "SavedStateHandle persistence", "process death recovery", "handleAction", "sendAction", "Hilt module", "Repository pattern", "implementing a screen", "adding a data source", "handling navigation", "encrypted storage", "security patterns", "Clock injection", "DataState", or any questions about implementing features, screens, ViewModels, data sources, or navigation in the AiSolver2048 Android app.
---

# Implementing Android Code - AiSolver2048 Quick Reference

**This skill provides tactical guidance for AiSolver2048-specific patterns.** For comprehensive architecture decisions and complete code style rules, consult `docs/ARCHITECTURE.md` and `docs/STYLE_AND_BEST_PRACTICES.md`.
...
**Reference:**
- `ui/src/main/java/io/github/helpigstar/aisolver2048/ui/platform/base/BaseViewModel.kt` (see `handleAction` method)
- `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginViewModel.kt` (see class declaration)
...
**Reference:** `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginNavigation.kt` (see `LoginRoute` and extensions)
    ...
    AisolverScaffold(
        topBar = {
            AisolverTopAppBar(
                ...
                navigationIcon = rememberVectorPainter(AisolverDrawable.ic_back),
...
**Reference:** `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginScreen.kt` (see `LoginScreen` composable)
...
- ✅ Use `Aisolver*` prefixed components from `:ui` module
...
**Reference:**
- `app/src/main/java/io/github/helpigstar/aisolver2048/data/auth/repository/AuthRepository.kt`
- `app/src/main/java/io/github/helpigstar/aisolver2048/data/tools/generator/repository/di/GeneratorRepositoryModule.kt`
...
The `:ui` module provides reusable `Aisolver*` prefixed components. Search before creating new ones.

**Common Components:**
- `AisolverFilledButton` - Primary action buttons
- `AisolverOutlinedButton` - Secondary action buttons
- `AisolverTextField` - Text input fields
- `AisolverPasswordField` - Password input with show/hide
- `AisolverSwitch` - Toggle switches
- `AisolverTopAppBar` - Toolbar/app bar
- `AisolverScaffold` - Screen container with scaffold
- `AisolverBasicDialog` - Simple dialogs
- `AisolverLoadingDialog` - Loading indicators

**Component Discovery:**
Search `ui/src/main/java/io/github/helpigstar/aisolver2048/ui/platform/components/` for existing `Aisolver*` components. For build, test, and codebase discovery commands, use the **`build-test-verify`** skill.
...
- Prefix with `Aisolver`
- Accept themed colors/styles from `AiSolver2048Theme`
...
- Reference strings via generated `AisolverString` resource IDs
...
**Reference:** `app/src/test/java/io/github/helpigstar/aisolver2048/ui/tools/feature/generator/GeneratorViewModelTest.kt`
...
- `core/src/main/java/io/github/helpigstar/aisolver2048/core/di/CoreModule.kt` (see `provideClock` function)
...
## AiSolver2048-Specific Anti-Patterns

**General anti-patterns are documented in CLAUDE.md.** This section covers violations specific to AiSolver2048's State-Action-Event, navigation, and data layer patterns:
...
Example: `ui/src/main/java/io/github/helpigstar/aisolver2048/ui/platform/base/BaseViewModel.kt` (see `handleAction` method)
