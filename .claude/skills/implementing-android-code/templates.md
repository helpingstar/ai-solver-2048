# Code Templates - AiSolver2048 Android
...
**Based on**: `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginViewModel.kt`
                ...
                mutableStateFlow.update {
                    it.copy(
                        ...
                        dialogState = ExampleState.DialogState.Error(
                            message = AisolverString.generic_error_message.asText(),
                    ...
                    it.copy(
                        ...
                        dialogState = ExampleState.DialogState.Error(
                            message = result.message?.asText()
                                ?: AisolverString.generic_error_message.asText(),
                        ),
                    )
                }
            }
...
**Based on**: `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginNavigation.kt`

```kotlin
@file:OmitFromCoverage

package io.github.helpigstar.aisolver2048.ui.feature.example
...
import io.github.helpigstar.aisolver2048.annotation.OmitFromCoverage
import io.github.helpigstar.aisolver2048.ui.platform.base.util.composableWithSlideTransitions
...
**Based on**: `app/src/main/java/io/github/helpigstar/aisolver2048/ui/auth/feature/login/LoginScreen.kt`
...
import io.github.helpigstar.aisolver2048.ui.platform.components.appbar.AisolverTopAppBar
...
fun ExampleScreen(
    ...
    AisolverScaffold(
        ...
        topBar = {
            AisolverTopAppBar(
                title = stringResource(id = AisolverString.example),
                scrollBehavior = scrollBehavior,
                navigationIcon = rememberVectorPainter(id = AisolverDrawable.ic_back),
...
**Based on**: `app/src/main/java/io/github/helpigstar/aisolver2048/data/tools/generator/repository/di/GeneratorRepositoryModule.kt`
...
**Based on**: `app/src/main/java/io/github/helpigstar/aisolver2048/data/auth/datasource/disk/di/AuthDiskModule.kt` and `AuthDiskSourceImpl.kt`
...
**Based on**: `app/src/test/java/io/github/helpigstar/aisolver2048/ui/tools/feature/generator/GeneratorViewModelTest.kt`
