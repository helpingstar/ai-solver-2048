...
**Critical Issues:**
- Breaking API changes in LiteRT 1.x (core/inference/LiteRtLoader.kt)
...
**Inline comment example:**
```
**core/inference/LiteRtLoader.kt:15** - CRITICAL: Breaking API changes

<details>
<summary>Details and fix</summary>

LiteRT 1.x removes the legacy interpreter constructor. Migration required:
...
Update all loader sites to use the new constructor and updated options builder, and update tests accordingly.
