---
description: Guided requirements refinement and implementation planning for AiSolver2048 Android
argument-hint: <free-text description of the feature or change>
---

# Android Planning Workflow

You are guiding the developer through requirements refinement and implementation planning for the AiSolver2048 Android project. The input to plan from is:
...
Parse the input as a free-text requirements description.

**Present a structured summary:**
1. Raw requirements extracted from the input
2. Initial scope assessment (small / medium / large)

**Gate**: User confirms the summary is complete and may add additional context before proceeding.
...
The skill will:
1. Consolidate the input into a working document
2. Evaluate requirements against a structured rubric (functional, technical, UX, cross-cutting)
...
To implement this plan, run:
    ...
    /work-on-android [feature reference]
...
**Save the document:**
- `.claude/outputs/plans/FEATURE-NAME-PLAN.md`
